...
# 🔹 1단계: 머신러닝 기초 (Supervised Learning Basics)

## 📌 단계 목표

- 지도학습(Supervised Learning) 구조 이해
- 분류(Classification) 문제 해결 방식 학습
- 훈련 세트 / 테스트 세트 분리 필요성 이해
- 데이터 전처리(Feature Scaling)의 중요성 이해
